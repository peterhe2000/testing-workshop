...
test('calls onSubmit with the username and password when submitted', () => {
  ...
  const usernameNode = getByLabelText('username') // find label with this name and find htmlfor to find input
  const passwordNode = getByLabelText('password') // label have text as id and input with aria-labelledby
  ...
  expect(submitButtonNode.type).toBe('submit') // If it is not submit button type, click submit button will not submit the form
})
